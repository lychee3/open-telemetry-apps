 ...
 */
export declare type DiagLogLevelString = keyof typeof DiagLogLevel;
/**
 ...
 * @returns {DiagLogger}
 */
export declare function createLogLevelDiagLogger(maxLevel: DiagLogLevel, logger?: DiagLogger | null): DiagLogger;
