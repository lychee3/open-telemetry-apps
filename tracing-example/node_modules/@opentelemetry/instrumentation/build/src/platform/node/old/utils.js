...
function getPackageVersion(basedir) {
    ...
    try {
        ...
        if (!semver.parse(version)) {
            api_1.diag.error(`getPackageVersion: [${pjsonPath}|${version}] Version string could not be parsed.`);
            return null;
        }
        return version;
    }
    catch (e) {
        api_1.diag.error(`getPackageVersion: [${pjsonPath}] An error occurred while retrieving version string. ${e.message}`);
        return null;
    }
}
